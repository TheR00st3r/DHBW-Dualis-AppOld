...
{
	/*
	 * Options: 1: Prüfungsnummer 2: Vorlesungsname 3: Datum 4. Credits 5. Note
	 * 6. ECTSnote 7. Status Englisch 8. oder 9. Status Deutsch
	 */
	// Database fields
	...
	{
		open();
		String strTmp = "SELECT " + KEY_PRUEFUNGSNUMMER + ", " + KEY_VORLESUNGSNAME + ", " + KEY_DATUM + ", " + KEY_CREDITS + ", " + KEY_NOTE + ", " + KEY_ECTSNOTE + ", " + KEY_STATUS + " FROM " + DB_TABLE + " WHERE " + KEY_ROWID + "=" + rowId;
	...
	{
		open();
		String strTmp = "SELECT " + KEY_PRUEFUNGSNUMMER + ", " + KEY_VORLESUNGSNAME + ", " + KEY_DATUM + ", " + KEY_CREDITS + ", " + KEY_NOTE + ", " + KEY_ECTSNOTE + ", " + KEY_STATUS + " FROM " + DB_TABLE + " ORDER BY " + KEY_PRUEFUNGSNUMMER;
		Cursor cursor = db.rawQuery(strTmp, null);
		return cursor;
	}
