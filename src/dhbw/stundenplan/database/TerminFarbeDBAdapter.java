...
public class TerminFarbeDBAdapter
{
	...
	{
		open();
		String strTmp = "SELECT " + KEY_VORLESUNG + ", " + KEY_FARBE + " FROM " + DB_TABLE + " WHERE " + KEY_ROWID + "=" + rowId;
	...
	public int gibVorelsungsFarbe(String vorlesung)
	{
		...
		try
		{
			String strTmp = "SELECT " + KEY_FARBE + " FROM " + DB_TABLE + " WHERE " + KEY_VORLESUNG + "=?";// +
																											// vorlesung;
																											// //TODO
	...
	private int neueFarbe()
	{
		...
		/*
		 * rot = rot + 20 + (31 * db); while (rot > 255) { rot = rot - 255; }
		 */
