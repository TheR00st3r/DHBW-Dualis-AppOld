...
public class HomeScreenWidget extends AppWidgetProvider 
{
	...
	public void doStuff()
	{
		...
		//c.getString(0);//0=Datum 1=Startzeit 2=Endzeit 3=Vorlesung 4=Raum 5=Wochentag
		...
		while(c.isLast())
		{
			try 
			{
				...
				if(datum.after(startzeit) ||datum.before(endzeit))
				{
					...
					//remoteViews.setTextViewText(R.id.widgetTV1, c.getString(0) + "\n" + c.getString(3) + "\n" + c.getString(1) + "-" + c.getString(2) + "\n" + c.getString(4));
					...
					do
					{
						...
						catch (Exception e) //TODO: Richtige Exception eintragen 
						{
							//TODO: Nachricht keine weitere vorlesung mehr
							
							//remoteViews.setTextViewText(R.id.widgetTV2, "Keine weiteren Daten vorhanden. Bitte Aktualisieren.");
							textView2 = false;
							break;
						}
						id++;
					...
					if(textView2)
					{
						...
						//remoteViews.setTextViewText(R.id.widgetTV2, c.getString(0) + "\n" + c.getString(3) + "\n" + c.getString(1) + "-" + c.getString(2) + "\n" + c.getString(4));	
					}
					break;
				}
				else
